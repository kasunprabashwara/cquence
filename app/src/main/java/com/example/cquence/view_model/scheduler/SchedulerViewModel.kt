...
//            _scheduledActions.value += ScheduledAction(nextAction.action, nextAction.time)
//            scheduledCount++
...
//            val timeUntilNextAction = nextScheduledAction.time - duration.inWholeMilliseconds
...
//                    waitOnNextAction()
//                }, timeUntilNextAction)
//                if(nextScheduledAction.action.audioTimeout > 0){
//                    handler.postDelayed({
//                        audioManager.stopAudio()
//                        _actionHappening.value = false
//                    }, timeUntilNextAction + nextScheduledAction.action.audioTimeout)
//                }
////            } else {
